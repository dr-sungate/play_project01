...
trait OAuth2ProviderExtend extends OAuth2BaseProvider  {
  ...
  protected def createOAuth2ProviderExtendResult(authInfo: AuthInfo[models.TablesExtend.OauthUsersRow], authCode: Oauth2DataHandlerObj.AuthorizationCode) = OAuth2ProviderExtendResult(
    authInfo,
    "Bearer",
    authCode.code,
    authCode.expiresIn,
  ...
  protected def responseAuthCode[OauthUsersRow](r: OAuth2ProviderExtendResult[OauthUsersRow]) = {
    Map[String, JsValue](
